...
- AI-Driven Recommendations — Suggests jobs based on user profiles.
...
- Profile picture Uploads — DP upload and parsing via Multer.
- Job Cache System — Faster access to job data with Redis caching.
- Rate Limiting — Prevents API abuse and excessive requests.
- Structured Logging — Implemented using Pino with log rotation using Pino-roll.
...
|   ├── AI-Job-API.postman_collection.json
|   |
├── src/
│   ├── config/
...
│   │
│   ├── controllers/
│   │   ├── adminControllers.js      # Handles user accoutns and stats
...
│   │   ├── uploadControllers.js     # Handles resume and profile image uploads
│   │
│   ├── middleware/
│   │   ├── authMiddleware.js        # JWT verification middleware
│   │   ├── authorizeAdmin.js        # Checks for admin accounts for admin only routes
...
│   │
│   ├── routes/
│   │   ├── adminRoutes.js           # Routes for admin endpoints
...
│   │   ├── uploadRoutes.js          # Routes for resume and profile image uploads
│   │   ├── index.js                 # Single export file for all routes
│   │
│   ├── services/
│   │   ├── adminService.js          # Business logic for admin actions
...
│   │   ├── uploadService.js         # Logic for managing and updating resume and profile image
│   │
│   ├── utils/
...
│   │   ├── otpGen.js                # Generates otp adn otp expiry date/time
|   |
│   └── app.js                       # Main entry point of the server
|   |
├── views/                           # Reusable EJS templates for email content
│   ├── includes/
│   │   │   ├── footer.ejs
│   │   │   ├── header.ejs
...
│   │   ├── welcomeMessage.ejs   
│   │
├── uploads/                         # Stores uploaded resumes and profile images
│
├── .env.example                     # Contains all required credntials for a .env file
├── .gitignore
├── package.json
├── package-lock.json
└── README.md
...
- footer.ejs, header.ejs – Shared components for emails in .views/includes
