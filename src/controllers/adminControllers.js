import { deleteUserService, getAllUsersServices, getStatsService } from "../services/adminService.js";
...
export const deleteUser = async (req, res) => {
    ...
    if (!user) return res.status(400).json({ message: "Invalid paramter "});

    res.status(200).json({ success: true, message: `User: ${id} deleted successfully`, user});
};
